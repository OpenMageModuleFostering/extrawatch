...
DEFINE('_EW_DESC_UNINSTALL_KEEP_DATA', "Kaldırma yaparken, Veritabanı Tabloları'nı tut. Sürüm yükseltme yapıyor ve verilerinizi saklamak istiyorsanız, kaldırma yapmadan önce bu seçeneği işaretleyin.");
